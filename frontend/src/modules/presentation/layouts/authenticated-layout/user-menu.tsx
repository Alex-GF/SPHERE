  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex items-center justify-center overflow-hidden rounded-full border border-tp-hairline bg-tp-cream transition-all hover:ring-2 hover:ring-tp-primary/20"
      >
        <Avatar w={32} h={32} />
      </button>
