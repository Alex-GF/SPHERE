...
export default function ChatInput({ question, isSubmitting, isDisabled, onQuestionChange, onSubmit, onFileDrop }: Props) {
      ...
      >
        ...
        <div className="flex items-center justify-between border-t border-tp-hairline-soft px-3 py-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-tp-primary px-3 py-1.5 text-xs font-medium text-tp-on-primary transition-colors hover:bg-tp-primary-deep disabled:cursor-not-allowed disabled:opacity-40"
          >
            {isSubmitting ? (
              <>
